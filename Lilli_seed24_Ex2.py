...
#bilateraler Schock 
shock_pairs = [(3,0),(3,1),(3,2),(3,4),(3,5)]
#shock_values = [100]
alphas = [2.0, 1.0, 0.8, 0.6, 0.4, 0.2, 0.0]
results = []
for i,j in shock_pairs:
    for alpha in alphas:
        f_res_sim, t_res_sim, solo, whole, k_shock_mat = shock_simulation(shock_edges=[(3,0),(3,1),(3,2),(3,4),(3,5)], alpha_edges=alpha, shock_start=40, shock_end=60) #davor 80
        results.append({
            "shock_pair": (i,j),
            "alpha":alpha,
...
plt.title(fr"Repräsentativ an Seed 24: Lagerstände der Länder mit Schock: Land D; $\alpha = 0$",
...
plt.ylabel("Δ Gesamthandel (Summe)",fontweight = "bold", fontsize = 14)
plt.title("Repräsentativ Seed 24 mulitlateraler Schock: Gesamthandelsdifferenz des Systems", fontweight = "bold", fontsize = 14)
plt.grid(True, alpha=0.3)
plt.show()
...
plt.ylabel("Δ Gesamthandel (Summe)", fontweight = "bold", fontsize = 14)
plt.legend(fontsize=10)
plt.title("Repräsentativ Seed 24 mulitlateraler Schock: Gesamthandelsdifferenz der Länder", fontweight = "bold", fontsize = 14)
plt.grid(True, alpha=0.3)
plt.show()
