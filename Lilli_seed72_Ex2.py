...
#bilateraler Schock 
shock_pairs = [(5,0),(5,1),(5,2),(5,3),(5,4)]
#shock_values = [100]
alphas = [2.0, 1.0, 0.8, 0.6, 0.4, 0.2, 0.0]
results = []
for i,j in shock_pairs:
    for alpha in alphas:
        f_res_sim, t_res_sim, solo, whole, k_shock_mat = shock_simulation(shock_edges=[(5,0),(5,1),(5,2),(5,3),(5,4)], alpha_edges=alpha, shock_start=40, shock_end=60) #davor 80
        results.append({
            "shock_pair": (i,j),
            "alpha":alpha,
